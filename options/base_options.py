...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--load_size', type=int, default=306, help='scale images to this size')
        # parser.add_argument('--load_target_size', type=int, default=286, help='scale images to this size')
